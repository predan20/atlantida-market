...
public class Register extends javax.swing.JPanel {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(registerPanelRegister, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public boolean registerButtonRegisterHandler(java.awt.event.ActionEvent evt) 
    {
		...
		if (match.find())
			...
			{
				if (pwd.length()<6) JOptionPane.showMessageDialog(this, "Password must have at least 6 characters!.", "Login Error", JOptionPane.ERROR_MESSAGE);
				else
				{
					if (!pwd.equals(cpwd))
					{
